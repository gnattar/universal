...
errorbar(C.mavgnogo_prcoccupancy(:,:,1),C.mavgnogo_prcoccupancy(:,:,2),C.mavgnogo_prcoccupancy(:,:,3)./sqrt(numanm_C),'color','k','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.5 .5 .5]);hold on;
errorbar(A.mavgnogo_prcoccupancy(:,:,1),A.mavgnogo_prcoccupancy(:,:,2),A.mavgnogo_prcoccupancy(:,:,3)./sqrt(numanm_A +1),'color','r','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.85 .5 .5]);hold on;
...
saveas(gcf,n,'fig');
saveas(gcf,n,'tif');
print(gcf,'-depsc2','-painters','-loose',n)
...
% set(gca,'FontSize',16);clc

% 

figure('position', [1000, sc(4)/10-100, sc(3)*1/3, sc(4)*1/3], 'color','w');
errorbar(C.mavgnogo_meanpole_data(:,:,1),C.mavgnogo_meanpole_data(:,:,2),C.mavgnogo_meanpole_data(:,:,3)./sqrt(numanm_C),'color','k','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.5 .5 .5]);hold on;
errorbar(A.mavgnogo_meanpole_data(:,:,1),A.mavgnogo_meanpole_data(:,:,2),A.mavgnogo_meanpole_data(:,:,3)./sqrt(numanm_A +1),'color','r','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.85 .5 .5]);hold on;
...
figure('position', [1000, sc(4)/10-100, sc(3)*1/3, sc(4)*1/3], 'color','w');
errorbar(C.mavgnogo_meanpole_data(:,:,1),C.avgContactFr(1,:),C.avgContactFr(2,:),'color','k','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.5 .5 .5]);hold on;
errorbar(A.mavgnogo_meanpole_data(:,:,1),A.avgContactFr(1,:),A.avgContactFr(2,:),'color','r','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.85 .5 .5]);hold on;
axis([0 9 0 1]);title('Rate of Contact GoTrials','FontSize',18);
...
figure('position', [1000, sc(4)/10-100, sc(3)*1/3, sc(4)*1/3], 'color','w');
errorbar(C.mavgnogo_meanpole_data(:,:,1),C.avgRewardFr(1,:),C.avgRewardFr(2,:),'color','k','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.5 .5 .5]);hold on;
errorbar(A.mavgnogo_meanpole_data(:,:,1),A.avgRewardFr(1,:),A.avgRewardFr(2,:),'color','r','Linewidth',1,'Marker','o','MarkerSize',15,'Markerfacecolor',[.85 .5 .5]);hold on;
axis([0 9 0 1]);title('Rate of Reward GoTrials','FontSize',18);
