...
%                 errorbar(binnedxdata+count,(binnedydata-baseline_bartheta),binnedydata_sdev,'color',tcol(k,:),'Marker','o','MarkerSize',6,'MarkerFaceColor',tcol(k,:));hold on;
                errorbar(binnedxdata+count,(binnedydata-mean_baseline(k)),binnedydata_sdev,'color',tcol(k,:),'Marker','o','MarkerSize',6,'MarkerFaceColor',tcol(k,:));hold on;
...
for j= 1:numblocks
    ...
    for i = 1:numsessions
        ...
        axes(ah4);
        if(i<num_baseline_sessions+1)
            axis([min(binnedxdata+count) max(binnedxdata+count) 0 5]);
            plot(binnedxdata+count,binnedydata./mean_baseline,'color',[.5 .5 .5],'Marker','o','MarkerSize',6,'MarkerFaceColor',[.5 .5 .5]);hold on;
            
        else
            axis([min(binnedxdata+count) max(binnedxdata+count) 0 5]);
            plot(binnedxdata+count,binnedydata./mean_baseline,'color',[0 0 0 ],'Marker','o','MarkerSize',6,'MarkerFaceColor',[0 0 0 ]);hold on;
