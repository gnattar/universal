...
function[w_setpoint_trials,w_setpoint_trials_med, w_setpoint_trials_medbinned,w_setpoint_trials_width,w_setpoint_trials_dur,w_setpoint_trials_prewhisk, w_setpoint_trials_prewhiskbinned,pvalsetpoint...
        ...
        for(i=1:1:length(trialnums))
            ...
            if(frames<1500)
                ...
                xt = [1:frames]*frameTime;
                    ...
                    temp = setpoint(round(restrictTime(1)/frameTime)-150+1:round(restrictTime(1)/frameTime)-50); %100points prewhisk
...
%          xt=[round(:size(setpoint_trials,2)]*frameTime;
