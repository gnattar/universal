...
function[w_thetaenv]...
    =  wdatasummary_devepoch(sessionInfo,obj,block_tags,block_trialnums,avg_trials,gopix,nogopix,restrictTime,pd,plot_whiskerfits,str,timewindowtag,min_meanbarpos,baseline_barpos,dev_threshold)
...
w_thetaenv = struct('thetaenvtrials',[],'time',[],'dist',[],'bins',[],'amp',[],'meandev_thetaenv',[],'meandev_thetaenv_binned',[],'meanpole_thetaenv',[],'meanpole_thetaenv_binned',[],...
                    'meandev_whiskamp',[],'meandev_whiskamp_binned',[], 'totaldev_whiskamp',[],'totaldev_whiskamp_binned',[],...
                    'meanpole_whiskamp',[],'meanpole_whiskamp_binned',[], 'totalpole_whiskamp',[],'totalpole_whiskamp_binned',[],...
...
for(blk=1:numblocks)
    ...
    var_set = {'meandev_thetaenv','peakdev_thetaenv','meanpole_thetaenv','prepole_thetaenv','prcoccupancy','meandev_whiskamp','totaldev_whiskamp','meanpole_whiskamp','totalpole_whiskamp'};
    col_set = {'k','r','b','g','k','k','b','k','b'};
