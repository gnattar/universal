...
%                   Default is no mask. For different masks for each trajectory ID, give a cell where
%                   comprising N elements, where N is the number of trajectory IDs. Each element is then
%                   a 2xN matrix as specified above. For instance, to have only one mask:
%                   [170 270 475 598; 1 80 89 88]. To have two masks:
%                   {[170 270 475 598; 1 80 89 88],[120 250 475 598; 1 70 87 85]}, etc.
%
