...
%             end
            ...
            if sum(missing)>=length(kappa)/3
                disp(['Err in kappa, Delete this trial: ' obj.trackerFileName])
                disp('Less than a third are Nan values for mean kappa timeseries.')
            end
            ...
            if sum(missing)>=length(theta)/3
                disp(['Err in theta, Delete this trial: ' obj.trackerFileName])
                disp('Less than a thrid are Nan values for mean theta timeseries.')
            end
            try
