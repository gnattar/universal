...
subfig = figure('IntegerHandle','off','Units','pixels',...
                ...
                'Name',getString(message('curvefit:cftoolgui:SelectPointsForExclusionRule')),...
                'MenuBar', 'figure', ...
                'NumberTitle','off',...
                'Color',figcolor,...
                'Tag','cfexcludegraph',...
...
for j=1:length(h)
   ...
   if  ~ismember( mtag, {'figMenuZoomIn', 'figMenuZoomOut', 'figMenuPan'} )
...
delete(h);
uimenu(hhelp, 'Label', getString(message('curvefit:cftoolgui:CurveFittingToolHelp')), 'Position',1,'Callback',...
       'cfswitchyard(''cfcshelpviewer'', ''cftool'', ''cftool'')'); 
uimenu(hhelp, 'Label',getString(message('curvefit:cftoolgui:CurveFittingToolboxHelp')), 'Position',2,'Callback',...
       'doc curvefit/'); 
...
b0 = uicontrol(subfig,'Units','pixels', 'Visible','off', ...
                      'String',getString(message('curvefit:cftoolgui:button_Close')), 'Parent',subfig, ...
                      'TooltipString',getString(message('curvefit:cftoolgui:tooltip_CloseSelectionWindow')), ...
                      'Callback',{@buttonselect 'close'}, ...
                      'Tag','close');
b1 = uicontrol(subfig,'Units','pixels', 'Visible','off',...
                      'String',getString(message('curvefit:cftoolgui:button_IncludeAll')), 'Parent',subfig, ...
                      'TooltipString',getString(message('curvefit:cftoolgui:tooltip_IncludeAllPoints')), ...
                      'Callback',{@buttonselect 'include'}, ...
                      'Tag','include');
b2 = uicontrol(subfig,'Units','pixels', 'Visible','off',...
                      'String',getString(message('curvefit:cftoolgui:button_ExcludeAll')), 'Parent',subfig, ...
                      'TooltipString',getString(message('curvefit:cftoolgui:tooltip_ExcludeAllPoints')), ...
...
e1(2) = e1(2) + 2*bheight;
b3 = uicontrol(subfig,'Style','radio','String',getString(message('curvefit:cftoolgui:button_IncludesThem')),...
                      'Units','Pixels','Position',e1,'Value',0,...
                      'HorizontalAlignment', 'left',...
                      'TooltipString',getString(message('curvefit:cftoolgui:tooltip_MouseSelectionIncludesPoints')),...
...
b4 = uicontrol(subfig,'Style','radio','String',getString(message('curvefit:cftoolgui:button_ExcludesThem')),...
                      'Units','Pixels','Position',e1,'Value',1,...
                      'HorizontalAlignment', 'left',...
                      'TooltipString',getString(message('curvefit:cftoolgui:tooltip_MouseSelectionExcludesPoints')),...
                      'Callback',{@buttonselect 'mouseexclude'},...
                      'Tag','mouseexclude');
e1(2) = e1(2) + textheight;
b5 = uicontrol(subfig,'Style','text','String',getString(message('curvefit:cftoolgui:button_SelectingPoints')),...
                      'HorizontalAlignment','left',...
...
b7 = uicontrol(subfig,'Style','text','String','Y: ',...
                      'Units','Pixels','Position',e1,...
                      'HorizontalAlignment','left',...
                      'TooltipString',getString(message('curvefit:cftoolgui:tooltip_SelectYVariableOrResiduals')),...
                      'Tag','ylabel');
...
for j=1:length(allfits)
   ...
   if isequal(f.dataset,dsname) && f.isGood
      allynames{end+1} = getString(message('curvefit:cftoolgui:button_Residuals',f.name)); %#ok<AGROW>
   end
end
...
c = curvefitlib.internal.getLegendItems( ax );
have3rd = (length(c)>2);
...
if isempty(c) || havebnds~=have3rd
   ...
   if havebnds
      legend(ax,[l1 l2 p1], getString(message('curvefit:cftoolgui:Included')),getString(message('curvefit:cftoolgui:Excluded')),...
             getString(message('curvefit:cftoolgui:OutsideDomainrange')),'Location','NorthOutside');
   else
      legend(ax,[l1 l2],getString(message('curvefit:cftoolgui:Included')),getString(message('curvefit:cftoolgui:Excluded')),...
