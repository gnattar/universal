function [warpedImage] = extern_warpImage(Image, originalMarks, desiredMarks)
...
% displaceX = griddata(x, y, zx, xi', yi, 'cubic', {'QJ'});   %%GRchange
% displaceY = griddata(x, y, zy, xi', yi, 'cubic', {'QJ'});   %%GRchange

if (0) %% DEBUG old
figure
imshow(displaceX,[-5 5]) ; colormap jet;
figure
imshow(displaceY,[-5 5]) ; colormap jet;
pause
end
