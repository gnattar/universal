%
% SP June 2010: This is code that is used by imreg_dft ; external and used for
%  LTP & NLX's data.  It is an improved FFT.
%

function [output Greg] = extern_dftregistration(buf1ft,buf2ft,usfac)
