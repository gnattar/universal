%
% For reading .seq files from StreamPix
%
function frames=extern_read_seq(seq_file, varargin)
...
[seq_info, fid] = extern_read_seq_header(seq_file);
...
frames = uint8(zeros(roi(4), roi(3), lastF-firstF+1) ); % nframes, width, height
