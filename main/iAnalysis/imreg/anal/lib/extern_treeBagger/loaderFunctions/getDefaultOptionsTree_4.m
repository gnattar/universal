function optionsTree = getDefaultOptionsTree_4
% It changes the path to save the data in encoderRF_cad
...
optionsTree.path                 = 'F:\Diego\Matlab\temp\Daniel\Results\encoderRF_cad\';
