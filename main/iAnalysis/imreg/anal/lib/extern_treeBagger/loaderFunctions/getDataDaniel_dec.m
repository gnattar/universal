function [x y_ev y_conv y_ca y_cad names type flagSignal] = getDataDaniel_dec (fileName)

%%
%--------------------------------------------------------------------------
%
% Goal : Gets the calcium and behavioral data as formatted by Daniel Huber
%--------------------------------------------------------------------------
