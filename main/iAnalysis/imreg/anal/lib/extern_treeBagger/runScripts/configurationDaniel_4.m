...
%              - It uses y_cad from getDaniel() as the calcium data
%            
%-------------------------------------------------------------------------------------------------------------
...
optionsTree = getDefaultOptionsTree_4;       % Default configuration
...
for idx = 1:N_files,
    ...
    % Only modification, now use the y_cad for y
    ...
    resultsFull             = getPSTHMultipleGo (orig_x,y,orig_names,'trial_class','',resultsFull);  % No multiple - GO information
    resultsFull             = getMetricsEncoder (orig_x,y,y_train,orig_names,'trial_class','',resultsFull);
...
%         resultsSingleFeature = getPSTHMultipleGo (orig_x,y,orig_names,'trial_class','',resultsSingleFeature);  % No multiple - GO information
%         resultsSingleFeature = getMetricsEncoder (orig_x,y,y_train,orig_names,'trial_class','',resultsSingleFeature);   
...
%         resultsSingleCategory = getPSTHMultipleGo (orig_x,y,orig_names,'trial_class','',resultsSingleCategory);  % No multiple - GO information
%         resultsSingleCategory = getMetricsEncoder (orig_x,y,y_train,orig_names,'trial_class','',resultsSingleCategory);   
...
%         resultsPairCategory = getPSTHMultipleGo (orig_x,y,orig_names,'trial_class','',resultsPairCategory);  % No multiple - GO information
%         resultsPairCategory = getMetricsEncoder (orig_x,y,y_train,orig_names,'trial_class','',resultsPairCategory);   
