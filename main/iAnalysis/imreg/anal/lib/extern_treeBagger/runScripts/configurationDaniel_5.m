...
optionsTree = getDefaultOptionsTree_5;       % Default configuration
...
for idx = 1:N_files,
    ...
    [orig_x y_ev y y_ca y_cad orig_names type flagSignal]    = getDataDaniel_dec (fileToLoad);   
    N_neurons                           = size(y,1);
