...
================================
-par_execute_cluster.ctf (component technology file)
-par_execute_cluster 
-run_par_execute_cluster.sh (shell script run to temporarily set environment variables 
                             and execute the application)
   -to run the shell script, type
   
       ./run_par_execute_cluster.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v717, run the shell script as:
       ...
       ./run_par_execute_cluster.sh /mathworks/home/application/v717
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_par_execute_cluster.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
A. Linux x86-64 systems:
   ...
   LD_LIBRARY_PATH by issuing the following commands:
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_par_execute_cluster.sh 
