...
set(handles.method_menu, 'String', {'Piecewise Rigid (globally non-Rigid)', ... 
                                     'Greeberg et al. (non-Rigid)', ...
																		 'FFT (Rigid)', ... 
																		 'Rigid with Rotation', ...
																		 '2D Affine 1 (translate ONLY)', ...
																		 '2D affine 2 (trans, rotate)', ...
																		 '2D affine 3 (trans, rot, scale)', ... 
																		 'Dombeck et al. HMM (non-Rigid)', ...
																		 'Normd cross-correlation 2d transl8 (Rigid)', ...
																		 'Downsampled FFT (Rigid)', ...
																		 'Subregion warp (Warpfield)'});
