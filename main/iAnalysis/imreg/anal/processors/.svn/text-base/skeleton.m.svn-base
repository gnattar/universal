...
%          process_single, process_batch, shutdown, and init have VERY specific
%          params structures passed to them by fluo_control_main.  Look below
%          to see the "official" definition of tihs.
% 
