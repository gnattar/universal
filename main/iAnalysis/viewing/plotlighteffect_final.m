function [meaneffect] = plotlighteffect_final(pooled_contact_CaTrials,grp)
...
hL=hist(Lt,[0:30:1000]);
hNL=hist(NLt,[0:30:1000]);
...
figure;
fnam = [ grp ' Fractional Change in event size Freq'];
plot([0:30:1000],frch_cfreq,'ko');
axis([0 600 0 1])
xlabel('Event size');
...
meaneffect.frch_cfreq = frch_cfreq;
save([grp 'meaneffect'],'meaneffect');
