...
x = ones(size(meaneffect.alleventrate_L,1),2);x(:,2) = 2;
plot(x',[meaneffect.alleventrate_NL(:,1)';meaneffect.alleventrate_L(:,1)'],'-o','color','k', 'Markersize',3,'Markerfacecolor','k');hold on;
h=errorbar([1;2],[nanmean(meaneffect.alleventrate_NL(:,1));nanmean(meaneffect.alleventrate_L(:,1))],[nanstd(meaneffect.alleventrate_NL(:,1))/sqrt(size(meaneffect.alleventrate_NL,1)); nanstd(meaneffect.alleventrate_L(:,1))/sqrt(size(meaneffect.alleventrate_L,1))],'-or');
set(h, 'linewidth',1.5,'Markersize',10,'Markerfacecolor','r');
...
plot(x',[meaneffect.allintarea_NL(:,1)';meaneffect.allintarea_L(:,1)'],'-o','color','k', 'Markersize',3,'Markerfacecolor','k');hold on;
h=errorbar([1;2],[nanmean(meaneffect.allintarea_NL(:,1));nanmean(meaneffect.allintarea_L(:,1))],[nanstd(meaneffect.allintarea_NL(:,1))/sqrt(size(meaneffect.allintarea_NL,1));nanstd(meaneffect.allintarea_L(:,1))/sqrt(size(meaneffect.allintarea_L,1))],'-or');
set(h, 'linewidth',1.5,'Markersize',10,'Markerfacecolor','r');
...
figure;fnam = [ grp 'Normalized Event Prob Histogram'];
...
figure;fnam = [ grp 'Normalized Event Prob Cumulative Histogram'];
