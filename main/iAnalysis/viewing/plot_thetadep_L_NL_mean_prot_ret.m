...
function plot_thetadep_L_NL_mean_prot_ret(pooled_contactCaTrials_thetadep,dends)
    sc = get(0,'ScreenSize');
...
%     print( gcf ,'-depsc2','-painters','-loose',[' Theta Dep  mean D ' num2str(dends)]);
saveas(gcf,[' Theta Dep mean D ' num2str(dends)],'jpg');
