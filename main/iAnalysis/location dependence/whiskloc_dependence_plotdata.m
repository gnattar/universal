...
for d=1:length(dends)
    ...
    for i = 1:numloc
        ...
        semilogx(abs(pooled_contactCaTrials_locdep{n}.totalKappa_epoch(NL_ind(retract))),pooled_contactCaTrials_locdep{n}.(par)(NL_ind(retract)),'o','color',[.5 .5 .5],'Markersize',7,'Markerfacecolor',[.5 .5 .5]); hold on;
        semilogx(abs(pooled_contactCaTrials_locdep{n}.totalKappa_epoch(NL_ind(protract))),pooled_contactCaTrials_locdep{n}.(par)(NL_ind(protract)),'ko','Markersize',7, 'Markerfacecolor',[0 0 0]); hold on;
        ...
        semilogx(abs(pooled_contactCaTrials_locdep{n}.totalKappa_epoch(L_ind(retract))),pooled_contactCaTrials_locdep{n}.(par)(L_ind(retract)),'o','color',[.85 .5 .5],'Markersize',7,'Markerfacecolor',[.85 .5 .5]); hold on;%axis( [0 5 -50 150]);
        semilogx(abs(pooled_contactCaTrials_locdep{n}.totalKappa_epoch(L_ind(protract))),pooled_contactCaTrials_locdep{n}.(par)(L_ind(protract)),'ro','Markersize',7,'Markerfacecolor',[1 0 0 ]); hold on;
        ...
        if strcmp(par,'sigmag')
            axis([10e-4 1.5 0 5000]);
        elseif strcmp(par,'sigpeak')
            axis([10e-4 1.5 0 900]);
        end
        count = count+1;
        ...
        semilogx([0.0001:.01:1.5],polyval(p_NL(i,:,1) ,[0.0001:.01:1.5]),'k-','linewidth',2);hold on;
        semilogx([0.0001:.01:1.5],polyval(p_L(i,:,1),[0.0001:.01:1.5]),'r-','linewidth',2);hold on;
        
        semilogx([0.0001:.01:1.5],polyval(p_NL(i,:,2) ,[0.0001:.01:1.5]),'color',[.5 .5 .5],'linewidth',2);hold on;
        semilogx([0.0001:.01:1.5],polyval(p_L(i,:,2),[0.0001:.01:1.5]),'color',[.85 .5 .5],'linewidth',2);  
...
%         plot([0.0001:.01:1.0],polyval(p_L(i,:,2),[0.0001:.01:1.0]),'color',[.85 .5 .5],'linewidth',2);       
    ...
    h= plot([1:numloc],p_L(:,1,2),'-o','color',[.85, .5 , .5]);set(h,'linewidth',1.5);
    hline(0,'k:');
