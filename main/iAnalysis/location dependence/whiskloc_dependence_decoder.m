function [pooled_contactCaTrials_locdep] = whiskloc_dependence_decoder(pooled_contactCaTrials_locdep,cond,str,train_test,pos,disc_func)
...
if strcmp(cond,'ctrl' )
    ...
    [dist_all,hist_all,chist_all,p50_all,pOL_all,p_all] = run_classify(train_resp,train_pos,train_tk,test_resp,test_pos,test_tk,train_test,disc_func);
...
elseif strcmp(cond,'ctrl_mani')
    ...
    [dist_all,hist_all,chist_all,p50_all,pOL_all,p_all]=run_classify(train_resp,train_pos,train_tk,test_resp,test_pos,test_tk,1,disc_func);
...
%     print( gcf ,'-depsc2','-painters','-loose',[str ' ' disc_func ' CTRL' tag]);
    ...
    elseif train_test == 0
        ...
        [dist_all,hist_all,chist_all,p50_all,pOL_all,p_all]=run_classify(train_resp,train_pos,train_tk,test_resp,test_pos,test_tk,0,disc_func);
        tag = 'ctrltrain';
    end
...
function [dist_all,hist_all,chist_all,p50_all,pOL_all,p_all] = run_classify(train_resp,train_pos,train_tk,test_resp,test_pos,test_tk,tt,disc_func)
