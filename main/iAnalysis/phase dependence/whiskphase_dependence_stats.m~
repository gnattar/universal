function [pooled_contactCaTrials_locdep]= whiskphase_dependence_stats(pooled_contactCaTrials_locdep,dends,traces)
wpar = 're_totaldK';
capar = 'sigpeak';
...
for d=1:length(dends)
    ...
    slopesCI = nan(numph,4,4);
        ...
        pooled_contactCaTrials_locdep{n}.phase.(['NL_fitparam']) = nan(numloc,2,2);
        pooled_contactCaTrials_locdep{n}.phase.(['NL_fitparamCI']) = nan(numloc,2,2);
        pooled_contactCaTrials_locdep{n}.phase.(['NL_fitevals']) = nan(numloc,3,2);
        pooled_contactCaTrials_locdep{n}.phase.(['L_fitparam']) = nan(numloc,2,2);
        pooled_contactCaTrials_locdep{n}.phase.(['L_fitparamCI']) = nan(numloc,2,2);
        pooled_contactCaTrials_locdep{n}.phase.(['L_fitevals']) = nan(numloc,3,2);
